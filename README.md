...
I'm a passionate developer who loves building creative, real-world projects — from AI-powered tools and computer vision systems to games and custom browser experiences. I enjoy combining hardware, software, and machine learning to make things that are actually useful (and cool).
...
### 🎙️ Voice Assistant
> **Python · SpeechRecognition · pyttsx3 · Tkinter**

A desktop voice assistant that listens to spoken commands and responds with synthesized speech.

- Google Speech Recognition for STT
- pyttsx3 for offline TTS with voice selection
...
[![Instagram](https://img.shields.io/badge/Instagram-E4405F?style=for-the-badge&logo=instagram&logoColor=white)](https://www.instagram.com/_.ken_k_/)
[![Discord](https://img.shields.io/badge/Discord-5865F2?style=for-the-badge&logo=discord&logoColor=white)](https://discord.gg/WBBYCyJbrb)
[![Facebook](https://img.shields.io/badge/Facebook-1877F2?style=for-the-badge&logo=facebook&logoColor=white)](https://www.facebook.com/profile.php?id=100014608938403)

---

<p align="center"><i>"The only way to learn is to build."</i></p>
